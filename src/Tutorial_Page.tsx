...
import app_launch from "./components/assets/tutorial/app_launch.png";
import login from "./components/assets/tutorial/login.png";
import access from "./components/assets/tutorial/access.png";
import allow from "./components/assets/tutorial/allow.png";
import map_screen from "./components/assets/tutorial/map_screen.png";
import start_meeting from "./components/assets/tutorial/start_meeting.png";
import meeting_notes from "./components/assets/tutorial/meeting_notes.png";
import end_meeting from "./components/assets/tutorial/end_meeting.png";
import client_details from "./components/assets/tutorial/client_details.png";
import focus_marker from "./components/assets/tutorial/focus_marker.png";
import client_screen from "./components/assets/tutorial/client_screen.png";
import add_client from "./components/assets/tutorial/add_client.png";
import activity from "./components/assets/tutorial/activity.png";
import profile_screen from "./components/assets/tutorial/profile_screen.png";
import sign_out from "./components/assets/tutorial/sign_out.png";
import trip_details from "./components/assets/tutorial/trip_details.png";
import single_leg_1 from "./components/assets/tutorial/single_leg_1.png";
import single_leg_2 from "./components/assets/tutorial/single_leg_2.png";
import single_leg_3 from "./components/assets/tutorial/single_leg_3.png";
import multi_leg_trip_1 from "./components/assets/tutorial/multi_leg_trip_1.png";
import multi_leg_trip_2 from "./components/assets/tutorial/multi_leg_trip_2.png";
  ...
  return (
    <div style={{ minHeight: '100vh', fontFamily: '"Inter", sans-serif', background: 'linear-gradient(180deg, #ecfeff 0%, #f8fafc 30%, #ffffff 100%)', position: 'relative', width: '100%', overflowX: 'hidden' }}>
      ...
      <motion.div animate={{ marginLeft: (!isMobile && sidebarOpen) ? 272 : 0 }} transition={{ type: 'spring', stiffness: 340, damping: 34 }}>
        ...
        {/* ── HERO ── */}
          <section style={{ padding: isMobile ? '2rem 1rem' : isTablet ? '2.5rem 1.5rem' : '1rem 1.5rem', minHeight: isMobile ? 'auto' : '500px', display: 'flex', alignItems: 'center', background: 'linear-gradient(135deg, #ecfeff 0%, #ffffff 50%, #ecfeff 100%)' }}>
          <div style={{ maxWidth: '1280px', margin: '0 auto', width: '100%', padding: isMobile ? '0' : '0 1.5rem' }}>
            <div style={{ display: isMobile ? 'flex' : 'grid', flexDirection: isMobile ? 'column' : undefined, gridTemplateColumns: isMobile ? undefined : isTablet ? '1fr' : '1.4fr 0.9fr', gap: isMobile ? '0rem' : isTablet ? '2.5rem' : '3rem', alignItems: 'start' }}>

              {isMobile && (
                <div style={{ paddingTop: '1.5rem', paddingBottom: '0.5rem', display: 'flex', justifyContent: 'center' }}>
                  <img src={logoImage} alt="GeoTrack" style={{ maxWidth: '100%', width: '220px', marginTop: '-12px', height: 'auto' }} />
                </div>
              )}
              {isMobile && (
              ...
              <div style={{ maxWidth: isMobile ? '100%' : '650px', marginTop: isMobile ? '0' : '-2.5rem', marginLeft: isMobile ? '0' : '0' }}>
                ...
                >
                  {!isMobile && (
                    <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.05 }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', marginLeft: '-4rem', marginBottom: '-2.5rem' }}>
                      <img src={logoImage} alt="Geotrack Logo" style={{ width: isTablet ? '16rem' : '20rem', height: 'auto', objectFit: 'contain' }} />
                    </motion.div>
                  )}
